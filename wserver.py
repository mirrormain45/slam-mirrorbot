...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      <div class="brand">
        <img
          src="https://telegra.ph/file/d8805be5ed790c47345fc.jpg"
          alt="logo"
        />
        <a href="https://t.me/GdriveMirrorCloud"> 
          <h2 class="name">Gdrive Mirror Cloud</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://t.me/GdriveMirrorCloud"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
async def list_torrent_contents(request):
    ...
    if "pin_code" not in gets.keys():
        rend_page = code_page.replace("{form_url}", f"/gdmc/files/{torr}")
    ...
    rend_page = rend_page.replace(
        "{form_url}", f"/gdmc/files/{torr}?pin_code={pincode}")
    client.auth_log_out()
    return web.Response(text=rend_page, content_type='text/html')
...
@routes.post('/gdmc/files/{hash_id}')
...
async def homepage(request):
    ...
    return web.Response(text="<h1>Join Gdrive Mirror Cloud <a href='https://t.me/GdriveMirrorCloud'>@GdriveMirrorCloud</a> By <a href='https://t.me/itsabdulkader'>@itsabdulkader</a></h1>", content_type="text/html")
    ...
    async def middleware_handler(request):
        ...
        try:
            ...
            if response.status == 404:
                return web.Response(text="<h1>404: Page not found</h2><br><h3>Gdrive Mirror Cloud</h3>", content_type="text/html")
            return response
